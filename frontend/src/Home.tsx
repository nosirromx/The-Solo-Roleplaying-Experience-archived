    ...
    return (
        <div className="content">
            ...
            <div className="content-section">
                ...
                <ul>
                    <li><strong>Freedom:</strong> Free yourself from relying on oracles and random tables. Experience a
                        new level of storytelling with our
                    ...
                    <li><strong>Use Any Existing Maps, Characters, or Other Materials:</strong>Simply upload your data
                        and the AI will help guide you without spoiling any secrets.
                    </li>
